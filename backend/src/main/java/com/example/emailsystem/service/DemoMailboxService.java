...
public class DemoMailboxService {
    ...
    public List<FolderResponse> listFolders(Long userId) {
        ...
        return folders.values().stream().filter(folder -> accountIds.contains(folder.accountId())).toList();
    }
